...
//     final error = await matchProvider.updateStats(widget.match.matchId!, _stats);
//
//     if (error != null) {
...
//                 const SizedBox(height: 16),
//
//                 // Yellow Cards (auto-calculated from timeline)
//                 _buildReadOnlyStat(
//                   title: 'Yellow Cards',
...
//                 const SizedBox(height: 16),
//
//                 // Red Cards (auto-calculated from timeline)
//                 _buildReadOnlyStat(
//                   title: 'Red Cards',
...
class _MatchStatsScreenState extends State<MatchStatsScreen> {
  ...
  Future<void> _updateStats() async {
    final matchProvider = Provider.of<MatchProvider>(context, listen: false);
    // ✅ FIXED: Changed from matchId to id
