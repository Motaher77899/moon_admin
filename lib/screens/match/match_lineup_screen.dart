...
//   final VoidCallback onUpdate;
//
//   const MatchLineupScreen({Key? key, required this.match, required this.onUpdate}) : super(key: key);
//
//   @override
//   State<MatchLineupScreen> createState() => _MatchLineupScreenState();
// }
//
// class _MatchLineupScreenState extends State<MatchLineupScreen> with SingleTickerProviderStateMixin {
//   late TabController _tabController;
//   List<PlayerLineUp> _selectedPlayers = [];
//   bool _isLoading = false;
//   String _currentTeamType = 'teamA';
//
//   @override
//   void initState() {
//     super.initState();
...
//       setState(() {
//         _currentTeamType = _tabController.index == 0 ? 'teamA' : 'teamB';
//         _loadLineup();
//       });
//     }
//   }
...
//   void _loadLineup() {
//     setState(() {
//       if (_currentTeamType == 'teamA') {
//         _selectedPlayers = widget.match.lineUpA != null ? List.from(widget.match.lineUpA!.players) : [];
//       } else {
//         _selectedPlayers = widget.match.lineUpB != null ? List.from(widget.match.lineUpB!.players) : [];
//       }
//     });
//   }
//
...
//           if (_selectedPlayers.isNotEmpty) _buildSaveButton(),
//         ],
//       ),
//     );
//   }
...
//             crossAxisAlignment: CrossAxisAlignment.start,
//             children: [
//               const Text('স্কোয়াড লাইনআপ', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
//               Text('${_selectedPlayers.length} জন প্লেয়ার সিলেক্টেড', style: TextStyle(color: Colors.grey[600], fontSize: 13)),
//             ],
//           ),
//           TextButton.icon(
//             onPressed: _openPlayerSelection,
//             icon: Icon(_selectedPlayers.isEmpty ? Icons.add_circle : Icons.edit, color: Colors.purple),
//             label: Text(_selectedPlayers.isEmpty ? 'নির্বাচন করুন' : 'এডিট', style: const TextStyle(color: Colors.purple, fontWeight: FontWeight.bold)),
//             style: TextButton.styleFrom(backgroundColor: Colors.purple.withOpacity(0.1), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20))),
//           ),
//         ],
//       ),
//     );
...
//             const SizedBox(height: 16),
//             const Text('কোন প্লেয়ার যোগ করা হয়নি', style: TextStyle(color: Colors.grey, fontSize: 16)),
//           ],
//         ),
//       );
//     }
...
//               child: Text(player.jerseyNumber.toString(), style: const TextStyle(color: Colors.orange, fontWeight: FontWeight.bold)),
//             ),
...
//               decoration: BoxDecoration(
//                 color: player.isSubstitute ? Colors.grey[100] : Colors.green[50],
//                 borderRadius: BorderRadius.circular(8),
//               ),
//               child: Text(
//                 player.isSubstitute ? 'সাবস্টিটিউট' : 'মেইন একাদশ',
//                 style: TextStyle(color: player.isSubstitute ? Colors.grey : Colors.green, fontSize: 11, fontWeight: FontWeight.bold),
//               ),
//             ),
//           ),
//         );
...
//                 : const Text('লাইনআপ সংরক্ষণ করুন', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.white)),
//           ),
//         ),
//       ),
//     );
//   }
//
//   // --- Methods (_openPlayerSelection & _saveLineup remain largely same but with updated logic) ---
//   // (আপনার আগের মেথডগুলো এখানে ব্যবহার করুন, শুধু logic sync রাখুন)
//
//   Future<void> _openPlayerSelection() async {
//     final teamProvider = Provider.of<TeamProvider>(context, listen: false);
//     String currentTeamId = _currentTeamType == 'teamA' ? widget.match.teamA : widget.match.teamB;
//
//     await teamProvider.fetchTeamPlayers(currentTeamId);
//     List<PlayerModel> allPlayers = teamProvider.teamPlayers[currentTeamId] ?? [];
//
//     if (allPlayers.isEmpty) {
//       _showSnackBar('এই টিমে কোন প্লেয়ার নেই', Colors.red);
//       return;
//     }
//
...
//           teamName: _currentTeamType == 'teamA' ? widget.match.teamA : widget.match.teamB,
//         ),
//       ),
//     );
//
...
//     setState(() => _isLoading = true);
//     final matchProvider = Provider.of<MatchProvider>(context, listen: false);
//     final lineup = LineUp(players: _selectedPlayers, formation: '');
//
//     String? error = await matchProvider.updateLineUp(
//         widget.match.id,
//         _currentTeamType == 'teamA' ? lineup : null,
//         _currentTeamType == 'teamB' ? lineup : null
//     );
//
//     setState(() => _isLoading = false);
//     if (error != null) {
...
//     } else {
//       _showSnackBar('লাইনআপ সফলভাবে সংরক্ষিত হয়েছে', Colors.green);
//       widget.onUpdate();
//     }
//   }
//
