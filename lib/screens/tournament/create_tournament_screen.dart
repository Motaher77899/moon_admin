...
//     );
//
//     // Create tournament and then assign teams to groups manually
...
//
//       // Create groups with manual assignment
...
//     try {
//       // Group teams by their assigned groups
...
//
//         print('✅ Created $groupName with ${groupTeams[groupName]!.length} teams');
//         order++;
//       }
//     } catch (e) {
...
//             const SizedBox(height: 20),
//
//             // Group Settings (only if format is 'groups')
//             if (_format == 'groups') ...[
...
//             const SizedBox(height: 20),
//
//             // Team Selection with Group Assignment
//             _buildSectionHeader(
...
//               bool isSelected = _selectedTeamIds.contains(team.teamId);
//
//               return Column(
//                 children: [
//                   CheckboxListTile(
...
//                           if (_format == 'groups') {
//                             _teamToGroupMap[team.teamId!] = _availableGroups.first;
//                           }
//                         } else {
//                           _selectedTeamIds.remove(team.teamId);
//                           _teamToGroupMap.remove(team.teamId);
//                         }
//                       });
//                     },
//                     activeColor: Colors.orange.shade700,
...
//                   ),
//
//                   // Group selector (only if team is selected and format is groups)
//                   if (isSelected && _format == 'groups')
//                     Padding(
//                       padding: const EdgeInsets.only(left: 72, right: 16, bottom: 12),
//                       child: DropdownButtonFormField<String>(
//                         value: _teamToGroupMap[team.teamId],
//                         decoration: InputDecoration(
...
//                         onChanged: (value) {
//                           setState(() {
//                             _teamToGroupMap[team.teamId!] = value;
//                           });
//                         },
//                       ),
//                     ),
