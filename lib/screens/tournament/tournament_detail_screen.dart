...
// //         ),
// //         content: const Text(
// //           'আপনি কি নিশ্চিত এই টুর্নামেন্ট এবং সকল ম্যাচ মুছতে চান?\n\nএটি পুনরুদ্ধার করা যাবে না।',
...
// //     Color statusColor = _currentTournament.status == 'ongoing'
// //         ? Colors.green
...
// //     return Scaffold(
// //       appBar: AppBar(
// //         title: const Text('টুর্নামেন্ট বিস্তারিত'),
...
// //           tabs: const [
// //             Tab(text: 'ম্যাচ', icon: Icon(Icons.sports_soccer, size: 20)),
// //             Tab(text: 'টিম', icon: Icon(Icons.groups, size: 20)),
// //             Tab(text: 'পয়েন্ট টেবিল', icon: Icon(Icons.table_chart, size: 20)),
// //           ],
// //         ),
// //       ),
// //       body: Column(
...
// //                 const SizedBox(height: 12),
// //                 Text(
// //                   '${_fullDateFormat.format(_currentTournament.startDate)} - ${_fullDateFormat.format(_currentTournament.endDate)}',
// //                   style: const TextStyle(
...
//     Color statusColor = _currentTournament.status == 'ongoing'
//         ? Colors.green
//         : _currentTournament.status == 'finished'
//         ? Colors.grey
//         : Colors.orange;
//
//     return Scaffold(
